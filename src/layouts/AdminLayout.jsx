      ...
      <div className="min-h-[100svh] bg-purple-50 px-4 py-6">
        <div className="mx-auto w-full max-w-3xl">
          <div className="rounded-3xl bg-white p-5 shadow-sm ring-1 ring-purple-200/60">
            ...
            <div
              role="alert"
              className="mt-3 rounded-xl border border-pink-300 bg-white px-3 py-2 text-sm"
            >
              {error}
            </div>
            <div className="mt-4">
              <button
                className="inline-flex h-10 items-center gap-2 rounded-xl border border-purple-200/60 bg-white px-3 text-sm font-semibold text-slate-900 shadow-sm transition hover:border-purple-200 hover:bg-purple-50 focus:outline-none focus:ring-4 focus:ring-purple-200"
                type="button"
      ...
      >
        <div className="flex items-center justify-between px-4 py-4 md:py-5">
          <div className="flex items-center gap-2">
            ...
            <div className="grid">
              <div className="text-sm font-extrabold tracking-tight">Natillera</div>
        ...
        <div className="px-4 pb-3">
          <div className="flex items-center gap-3 rounded-3xl border border-purple-200/60 bg-white px-3 py-3 shadow-sm">
            ...
            <div className="min-w-0">
              <div className="truncate text-sm font-bold">{profile?.full_name || 'Admin'}</div>
        ...
        <div className="flex-1 px-3 pb-4">
          <nav className="grid gap-1">
            ...
            <NavItem
              to="/admin/perfil"
              icon={<UserPen className="h-4 w-4" aria-hidden="true" />}
              onNavigate={onNavigate}
            >
              Editar Perfil
            </NavItem>
        ...
        <div className="mt-auto px-3 pb-5">
          ...
          >
            <span
              className="grid h-9 w-9 place-items-center rounded-2xl border border-pink-300/70 bg-white text-pink-600 shadow-sm"
              aria-hidden="true"
            >
